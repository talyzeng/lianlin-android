...
import com.plistview.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (isScrollLoadEnabled() && hasMoreData()) {
            if (scrollState == OnScrollListener.SCROLL_STATE_IDLE 
                ...
                BaseActivity.now_x=mListView.getScrollX();
                BaseActivity.now_y=mListView.getScrollY();
    ...
    //    mListView.getAdapter().notify();//提醒adapter更新  
     
     //   mListView .setSelection(lastItem - 1);//设置listview的当前位置，如果不设
    //   
    }
